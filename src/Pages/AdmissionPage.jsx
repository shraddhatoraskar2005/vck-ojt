...
const Admission = () => {
    return(
        <div id="admission">
           ...
           <h1 id="head2">Admissions at Vivekanand College</h1>
           <p>Welcome to the Admissions page of Vivekanand College! We are delighted you're considering joining
             our vibrant academic community.Our admission process is designed to be straightforward and accessible.</p> 
            ...
            <p>
                ...
                <Link to="/courses"className="tab1">Coursespage</Link> or
                 <Link to="/contact" className="tab1">Contactus</Link> directly.
            </p>
            </div>
            <Footer/>
        </div>
